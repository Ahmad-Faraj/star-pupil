...
| 2 | 0:10–0:32 | Type `photosynthesis`, **Start the lesson**. Skeleton map, then the whole subject arrives, every concept dark. Seal hash lands in the paper card | "Before I say a word, the examiner draws the subject. Every concept a fair lesson has to cover, and all of it dark, because I haven't taught any of it yet. Then it seals an exam against that map. That hash is the receipt: I can't teach to a test I've never seen." | hold on the dark map as it draws itself, then zoom the `seal ····` hash |
| 3 | 0:32–0:56 | Paste line 1, then line 2. Concepts turn **gold** and the coverage bar climbs; "in the notebook" dots appear; Pip asks a clarifying question | "Now I teach, and I watch it land. Say it clearly and the concept lights gold. The bar underneath is how much of the subject I've actually reached. And when I'm vague, he pushes back, exactly like a real student." | zoom the map as concepts light; hold on Pip's clarifying reply |
